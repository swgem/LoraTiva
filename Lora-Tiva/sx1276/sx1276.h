...
protected:
    ...
    */
    ...
    uint32_t txTimeoutTimer;
    void (*txTimeoutWrapper)(void);

    uint32_t rxTimeoutTimer;
    void (*rxTimeoutWrapper)(void);

    uint32_t rxTimeoutSyncWord;
    void (*rxTimeoutSyncWordWrapper)(void);
...
protected:
     ...
     */
    virtual void IoIrqInit( void (**irqHandlers)() ) = 0;
